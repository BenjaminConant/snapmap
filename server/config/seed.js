...
//             var data = {
//               storeId: resolvedFourObjs[i].storeId,
//               categories: resolvedFourObjs[i].categories, 
//               phoneNumber: resolvedFourObjs[i].phone, 
//               formattedPhone: resolvedFourObjs[i].formattedPhone, 
//               delivery: resolvedFourObjs[i].delivery, 
//               storeUrl: resolvedFourObjs[i].storeUrl
//             };
//             var updated = _.merge(store, data)
//             console.log('store2: ', updated)
